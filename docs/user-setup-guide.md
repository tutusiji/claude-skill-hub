...
claude plugin marketplace add http://your-internal-host:7789/platform-team/skill-hub.git
```

或者在 Claude Code 交互界面内执行：

```
/plugin marketplace add http://your-internal-host:7789/skill-hub.git
```
...
**Web 界面**：浏览器打开 http://your-internal-host:7788
...
检查：
1. 内网能访问 `http://your-internal-host:7789`（`curl http://your-internal-host:7789`）
...
| 操作 | 命令 |
|------|------|
| 添加内部 marketplace | `claude plugin marketplace add http://your-internal-host:7789/skill-hub.git` |
| 更新 marketplace | `claude plugin marketplace update internal-skill-hub` |
| 列出 marketplace | `claude plugin marketplace list` |
| 浏览插件 (Web) | 浏览器打开 `http://your-internal-host:7788` |
